...
const recentActivities = [
  {
    ...
    text: "Đối tác mới đăng ký",
    detail: "Hanoi Heritage Hotel",
    time: "2 phút trước",
    icon: Building,
  ...
  },
  {
    ...
    text: "Đặt chỗ hoàn thành",
    detail: "Đảo Ngọc Xanh Tour",
    time: "15 phút trước",
    icon: CheckCircle,
  ...
  },
  {
    ...
    text: "Yêu cầu xác minh từ",
    detail: "Saigon Street Food Tour",
    time: "1 giờ trước",
    icon: AlertCircle,
