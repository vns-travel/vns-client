              ...
              <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
                <div className="p-4 bg-green-50 border border-green-100 rounded-xl">
                  ...
                  <p className="text-xs text-green-600 mt-1">
                    Từ {platformStats.totalTransactions} giao dịch
                  </p>
                </div>
                <div className="p-4 bg-blue-50 border border-blue-100 rounded-xl">
                  ...
                  <p className="text-2xl font-bold text-blue-900 mt-1">
                    {fmt(platformStats.platformFees)}
                  </p>
                  <p className="text-xs text-blue-600 mt-1">
                    Lợi nhuận ròng của nền tảng
                  </p>
                </div>
                <div className="p-4 bg-purple-50 border border-purple-100 rounded-xl">
                  ...
                  <p className="text-2xl font-bold text-purple-900 mt-1">
                    {fmt(platformStats.partnerPayouts)}
                  </p>
                  <p className="text-xs text-purple-600 mt-1">
                    90% doanh thu trả về đối tác
                  </p>
                </div>
              </div>
                    ...
                    <div className="flex-1 min-w-0">
                      ...
                      <div className="w-full bg-gray-100 rounded-full h-1.5">
                        <div
                          ...
                          style={{
                            width: `${(p.amount / partnerPayouts[0].amount) * 100}%`,
                          }}
                        />
                      </div>
                    </div>
                ...
                {transactions.map((t) => {
                  ...
                  return (
                    <tr key={t.id} className="hover:bg-gray-50">
                      ...
                      <td
                        className={`px-6 py-4 font-semibold ${tc.amountColor}`}
                      >
                        {fmt(t.amount)}
                      </td>
